...
function love.conf(t)
    ...
    t.window.title = "Dummy Bird "..VERSION._           -- The window title (string)
    --t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width = 1080/2                  -- The window width (number)
    t.window.height = 1920/2                -- The window height (number)
